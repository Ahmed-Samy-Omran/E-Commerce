...
class UserViewModel(
    ...
    fun setIsLoggedIn(b: Boolean) =viewModelScope.launch {
        userPreferencesRepository.saveLoginState(b)
    }
}

class UserViewModelFactory(private val userPreferencesRepository: UserDataStoreRepositoryImpl) : ViewModelProvider.Factory {
