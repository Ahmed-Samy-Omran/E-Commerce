...
import com.example.data.datasource.datastore.DataStoreKeys.E_COMMERCE_PREFERENCES
import com.example.data.datasource.datastore.DataStoreKeys.USER_DETAILS_PREFERENCES_PB
...
object DataStoreKeys{
    ...
    const val USER_DETAILS_PREFERENCES_PB = "user_details.pb" // that is the same name of file + pb
}
